    ...
    <footer class="page-footer">
      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
				...
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:+947771123456">+94 777 112 34 56</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:support@bauhinia.com" class="email__addr">support@bauhinia.com</a>
				</div>
			</div>
      ...
      <div class="page-footer__subline">
        <div class="container clearfix">
          ...
          <div class="copyright">
            &copy; <?php echo date("Y");?> Bauhinia Clothings&trade;
          </div>
